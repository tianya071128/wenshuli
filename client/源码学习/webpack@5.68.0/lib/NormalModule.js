...
class NormalModule extends Module {
  ...
  /**
   * @param {WebpackOptions} options webpack options 配置项
   * @param {Compilation} compilation the compilation
   * @param {ResolverWithOptions} resolver the resolver
   * @param {InputFileSystem} fs the file system Node fs 模块
   * @param {NormalModuleCompilationHooks} hooks the hooks
   * @param {function((WebpackError | null)=): void} callback callback function
   * @returns {void}
   */
  _doBuild(options, compilation, resolver, fs, hooks, callback) {
    // 为 loader 的执行创建 loader 上下文：https://webpack.docschina.org/api/loaders/#the-loader-context
